<%@ Page Title="" Language="VB" MasterPageFile="~/ContentMasterPage.master" AutoEventWireup="false" CodeFile="frmReport_Booking_Personel.aspx.vb" Inherits="frmReport_Booking_Personel" %>
     ...
     <form id="form1" runat="server">
                 ...
                 <div class="main-content">
                     <div class="breadcrumbs" id="breadcrumbs">
                         <ul class="breadcrumb">
                             ...
                             <li class="active">Booking meeting room report by Personal</li>
                         </ul>
                         <!--.breadcrumb-->
                     ...
                     <div class="page-content">
                         ...
                         <div class="row-fluid">
                             <div class="span12">
                                 ...
                                 <div class="row-fluid">
                                     <h3 class="header smaller lighter blue">Booking meeting room report by Personal</h3>
                                 ...
                                 <div class="row-fluid">
                                     <div class="span2">
                                         <label class="control-label" for="lblAtendent">Personal</label>

                                     </div>
                                     <div class="span4">
                                         <input type="text" class="input-mini" id="txtPersonal" style="width: 205px; resize: none;" />
                             ...
                             <div class="row-fluid">
                                 <div class="span12">
                                     <button class="btn btn-danger btn-small" type="button" id="btnExport" style="display:none" runat="server"  >
        ...
        <script type="text/javascript">
            ...
            function populateExport() {
                ...
                var para = '?buildingid=' + buildingid + '&roomid=' + roomid + '&personal=' + personal ;

                var dataurl = 'frmReport_Booking_Personel.ashx' + para;
            ...
            function populateTable() {
                ...
                $.ajax({
                    type: "POST",
                    url: 'WebSevice/WebService.asmx/RenderBookingPersonal',
                    dataType: 'JSON',
                    data: param,
