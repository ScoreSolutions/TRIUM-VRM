<%@ WebHandler Language="VB" Class="frmReport_Booking_Daily" %>
...
Public Class frmReport_Booking_Daily : Implements IHttpHandler
    ...
    Public Sub ProcessRequest(ByVal context As HttpContext) Implements IHttpHandler.ProcessRequest
        ...
        Using ep As New ExcelPackage
            ...
            dt = webs.GetdataforBookingRoomType(buildingid, roomid, datefrom, dateto)
