...
Partial Class frmReport_Booking_Monthly
    ...
    '        Dim dt As New DataTable
    '        dt = cls.GetMonthEng
    '        cbMonthFrom.DataTextField = "month"
    '        cbMonthFrom.DataValueField = "id"
    '        cbMonthFrom.DataSource = dt
    '        cbMonthFrom.DataBind()
    '        cbMonthFrom.Items.Insert(0, New ListItem("Choose a Month From ...", ""))

    '        cbMonthTo.DataTextField = "month"
    '        cbMonthTo.DataValueField = "id"
    '        cbMonthTo.DataSource = dt
    '        cbMonthTo.DataBind()
    '        cbMonthTo.Items.Insert(0, New ListItem("Choose a Month To ...", ""))
    '    End Sub
    ...
    '        Dim dt As New DataTable
    '        dt = cls.GetYear(10)
    '        cbYearFrom.DataTextField = "year"
    '        cbYearFrom.DataValueField = "id"
    '        cbYearFrom.DataSource = dt
    '        cbYearFrom.DataBind()
    '        cbYearFrom.Items.Insert(0, New ListItem("Choose a Year From ...", ""))

    '        cbYearTo.DataTextField = "year"
    '        cbYearTo.DataValueField = "id"
    '        cbYearTo.DataSource = dt
    '        cbYearTo.DataBind()
    '        cbYearTo.Items.Insert(0, New ListItem("Choose a Year From ...", ""))
    '    End Sub
    ...
    '    Function GetDataForBookingMonthly() As DataTable
    '        Dim building As String = cbBuilding.Value
    '        Dim room As String = cbRoom.Value
    '        Dim monthfrom As String = cbMonthFrom.Value
    '        Dim monthto As String = cbMonthTo.Value
    '        Dim yearfrom As String = cbYearFrom.Value
    '        Dim yearto As String = cbYearTo.Value
    '        Dim dt As New DataTable
    '        Dim cls As New clsFunction
    '        dt = cls.getdataforbookingmonthly(building, room, yearfrom, yearto, monthfrom, monthto)

    '        Return dt
    '    End Function

    '    Private Sub RenderReport(ByVal dt As DataTable)
