<%@ Page Title="" Language="VB" MasterPageFile="~/ContentMasterPage.master" AutoEventWireup="false" CodeFile="frmReport_Visitor_Daily.aspx.vb" Inherits="frmReport_Visitor_Daily" %>
                ...
                <div class="main-content">
                    <div class="breadcrumbs" id="breadcrumbs">
                        <ul class="breadcrumb">
                            ...
                            <li class="active">Visitor report by daily</li>
                        </ul>
                        <!--.breadcrumb-->
                    ...
                    <div class="page-content">
                        ...
                        <div class="row-fluid">
                            <div class="span12">
                                ...
                                <div class="row-fluid">
                                    <h3 class="header smaller lighter blue">Visitor report by daily</h3>
        ...
        <script type="text/javascript">
         ...
         <script type="text/javascript">
             ...
             function populateExport() {
                 ...
                 var dataurl = 'frmReport_Visitor_Daily.ashx' + para;
             ...
             function populateTable() {
                ...
                // alert(param);
                 ...
                 $.ajax({
                     type: "POST",
                     url: 'WebSevice/WebService.asmx/RenderVisitorDaily',
                     dataType: 'JSON',
                     data: param,
