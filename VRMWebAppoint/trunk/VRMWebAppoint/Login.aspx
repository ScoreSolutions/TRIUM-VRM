...
<head>
    <meta charset="utf-8" />
    <title>Login Page - VRM Admin</title>
                        ...
                        <div class="row-fluid">
                            <div class="center">
                                <h1>
                                    ...
                                    <span class="red">VRM Appointment</span>
                                    <span class="white">Application</span>
                                </h1>
                                <h4 class="blue">&copy; Score Solution</h4>
                            </div>
                        </div>
                                                        ...
                                                        <fieldset>
                                                            <label>
                                                                <span class="block input-icon input-icon-right">
                                                                    <input type="text" class="span12" placeholder="Username" runat="server" id="txtUsername" />
                                                                    <i class="icon-user"></i>
                                                                </span>
                                                            </label>
                                                            ...
                                                            <label>
                                                                <span class="block input-icon input-icon-right">
                                                                    <input type="password" class="span12" placeholder="Password" runat="server" id="txtPassword" />
                                                                    <i class="icon-lock"></i>
                                                                </span>
                                                            </label>
                                                            ...
                                                            <div class="clearfix center">
                                                                ...
                                                                <button class="width-100 btn btn-small btn-primary" id="btnLogin" runat="server" onserverclick="Login_Click">
                                                                    <i class="icon-key"></i>
                                                                    Login
                                                                </button>
