<%@ WebHandler Language="VB" Class="frmReport_Booking_Monthly" %>
...
Public Class frmReport_Booking_Monthly : Implements IHttpHandler
    ...
    Public Sub ProcessRequest(ByVal context As HttpContext) Implements IHttpHandler.ProcessRequest
        ...
        Using ep As New ExcelPackage
            Dim ws As ExcelWorksheet = ep.Workbook.Worksheets.Add("BookingMonthlyReport")
            ...
            dt = webs.GetdataforBookingMonthly(buildingid, roomid, yearfrom, yearto, monthfrom, monthto)
