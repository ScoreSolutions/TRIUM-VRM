<%@ WebHandler Language="VB" Class="frmReport_Booking_Department" %>
...
Public Class frmReport_Booking_Department : Implements IHttpHandler
    
    Public Sub ProcessRequest(ByVal context As HttpContext) Implements IHttpHandler.ProcessRequest
        Dim url As String = context.Request.RawUrl
        Dim strTemp As String() = url.Split("&")
        Dim buildingid, roomid, department As String
        ...
        Using ep As New ExcelPackage
            Dim ws As ExcelWorksheet = ep.Workbook.Worksheets.Add("BookingDepartmentReport")
            ...
            dt = webs.GetdataforBookingDepartment(buildingid, roomid, department)
