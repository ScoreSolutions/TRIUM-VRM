<%@ Page Title="" Language="VB" MasterPageFile="~/ContentMasterPage.master" AutoEventWireup="false" CodeFile="frmContract.aspx.vb" Inherits="frmContract" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="main-content">
        ...
        <div class="page-content">
            ...
            <div class="row-fluid">
                <div class="span12">
                    <!--PAGE CONTENT BEGINS-->
                    <h3 class="header smaller lighter blue" id="headertext">Contract</h3>
                    ...
                    <div id="dialog-edit">
                        <div class="row-fluid">
                            ...
                            <div class="span2">
                                ...
                                <span class="help-inline color red" id="lblvalidDateTo" style="display: none">This field is required</span>
    ...
    <script type="text/javascript">
        ...
        //Call
        function LoadData() {
            var dataurl = 'WebSevice/WebService.asmx/LoadContractAll';
            $.ajax({
                "type": "POST",
                "dataType": 'json',
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (strvalue.length == 1) {
                        ...
                        $('#txtDateTo').val(strvalue[0].end_contract_date);
                ...
                buttons: {
                    "Save": function () {
                        ...
                        if (checkvalid == true) {
                            ...
                            if (checkid_duplicate($('#txtCardID').val(),id) == false) {
        ...
        function onSave() {
            ...
            $.ajax({
                type: "POST",
                url: "WebSevice/WebService.asmx/SaveContract",
                data: param,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                ...
                buttons: [
                            {
                                ...
                                click: function () {
                                    ...
                                    if (checkvalid == true) {
                                        ...
                                        if (dateCheck($('#txtDateFrom').val(), $('#txtDateTo').val()) == false) {
                                            div.dialog("close");
                                            onAlert("Date to < date from. Please modify date to");
                                        } else {
                                            div.dialog("close");
                                            onSave();
                                        }
        ...
        function checkid_duplicate(id_cardno,id) {
            var jsonobject = JSON.parse(localStorage['visitordata']);
            var checkjsonobject = getObjects(jsonobject, 'id_cardno', id_cardno);
            //var checkjsonobject_id = getObjects(jsonobject, 'id', id);
