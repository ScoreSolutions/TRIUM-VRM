<%@ Page Title="" Language="VB" MasterPageFile="~/ContentMasterPage.master" AutoEventWireup="false" CodeFile="frmReport_Booking_Department.aspx.vb" Inherits="frmReport_Booking_Department" %>
                 ...
                 <div class="main-content">
                     <div class="breadcrumbs" id="breadcrumbs">
                         <ul class="breadcrumb">
                             ...
                             <li class="active">Booking meeting room report by department</li>
                         </ul>
                         <!--.breadcrumb-->
                     ...
                     <div class="page-content">
                         ...
                         <div class="row-fluid">
                             <div class="span12">
                                 ...
                                 <div class="row-fluid">
                                     <h3 class="header smaller lighter blue">Booking meeting room report by department</h3>
                                 ...
                                 <div class="row-fluid">
                                     <div class="span2">
                                         <label class="control-label" for="lblRoomType">Department</label>
                                     </div>
                                     <div class="span4">
                                         <select class="chzn-select" id="cbDepartment" data-placeholder="Choose a Department ..." >
                                         </select>
                                     </div>
                                 </div>
                                 <br />
        ...
        <script type="text/javascript">
         ...
         <script type="text/javascript">
             ...
             function populateExport() {
                 ...
                 var para = '?buildingid=' + buildingid + '&roomid=' + roomid + '&department=' + department ;

                 var dataurl = 'frmReport_Booking_Department.ashx' + para;
             ...
             function populateTable() {
                 ...
                 $.ajax({
                     type: "POST",
                     url: 'WebSevice/WebService.asmx/RenderBookingDepartment',
                     dataType: 'JSON',
                     data: param,
             ...
             function populateSelect() {
                 ...
                 $.ajax({
                     type: "POST",
                     url: 'WebSevice/WebService.asmx/LoadActiveDepartment',
                     dataType: 'JSON',
                     contentType: "application/json; charset=utf-8",
                     success: function (data) {
                         var jsonobject = JSON.parse(data.d);
                         ...
                         $selectDepartment.append('<option value="">Choose all</option>');
                         //append a select option
                         $.each(jsonobject, function (key, val) {
