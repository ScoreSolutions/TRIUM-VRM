<%@ Page Title="" Language="VB" MasterPageFile="~/ContentMasterPage.master" AutoEventWireup="false" CodeFile="frmReport_Booking_Monthly.aspx.vb" Inherits="frmReport_Booking_Monthly" %>
                 ...
                 <div class="main-content">
                     <div class="breadcrumbs" id="breadcrumbs">
                         <ul class="breadcrumb">
                             ...
                             <li class="active">Booking meeting room report by monthly</li>
                         </ul>
                         <!--.breadcrumb-->
                     ...
                     <div class="page-content">
                         ...
                         <div class="row-fluid">
                             <div class="span12">
                                 ...
                                 <div class="row-fluid">
                                     <h3 class="header smaller lighter blue">Booking meeting room report by monthly</h3>
                                 ...
                                 <div class="row-fluid">
                                     <div class="span2">
                                         <label class="control-label" for="lblYearFrom">Year From</label>
                                     </div>
                                     <div class="span4">
                                     ...
                                     <div class="span2">
                                         <label class="control-label" for="lblYearTo">Year To</label>
                                     </div>
                                     <div class="span4">
                                 ...
                                 <div class="row-fluid">
                                     <div class="span2">
                                         <label class="control-label" for="lblMonthFrom">Month From</label>
                                     </div>
                                     <div class="span4">
                                     ...
                                     <div class="span2">
                                         <label class="control-label" for="lblMonthTo">Month To</label>
                                     </div>
                                     <div class="span4">
        ...
        <script type="text/javascript">
         ...
         <script type="text/javascript">
             ...
             function populateExport() {
                 ...
                 var dataurl = 'frmReport_Booking_Monthly.ashx' + para;
             ...
             function populateTable() {
                 ...
                 $.ajax({
                     type: "POST",
                     url: 'WebSevice/WebService.asmx/RenderBookingMonthly',
                     dataType: 'JSON',
                     data: param,
