<%@ WebHandler Language="VB" Class="frmReport_Booking_RoomType" %>
...
Public Class frmReport_Booking_RoomType : Implements IHttpHandler
    
    Public Sub ProcessRequest(ByVal context As HttpContext) Implements IHttpHandler.ProcessRequest
       
        Dim url As String = context.Request.RawUrl
        Dim strTemp As String() = url.Split("&")
        Dim buildingid, roomtype, datefrom, dateto As String
        ...
        Using ep As New ExcelPackage
            Dim ws As ExcelWorksheet = ep.Workbook.Worksheets.Add("BookingRoomTypeReport")
            ...
            dt = webs.GetdataforBookingRoomType(buildingid, roomtype, datefrom, dateto)
