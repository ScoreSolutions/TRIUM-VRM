<%@ WebHandler Language="VB" Class="frmReport_Visitor_Daily" %>
...
Public Class frmReport_Visitor_Daily : Implements IHttpHandler
    
    Public Sub ProcessRequest(ByVal context As HttpContext) Implements IHttpHandler.ProcessRequest
        Dim url As String = context.Request.RawUrl
        Dim strTemp As String() = url.Split("&")
        Dim buildingid, roomid, datefrom, dateto As String
        ...
        Using ep As New ExcelPackage
            Dim ws As ExcelWorksheet = ep.Workbook.Worksheets.Add("VisitorDailyReport")
            ...
            dt = webs.GetdataforVisitorDaily(buildingid, roomid, datefrom, dateto)
