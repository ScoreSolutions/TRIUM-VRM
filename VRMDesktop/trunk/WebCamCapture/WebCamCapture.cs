...
namespace WebCam_Capture
{
  ...
  */
        ...
        public DataTable LoadDeviceList()
        {
            DataTable dt = new DataTable();
            dt.Columns.Add("id");
            dt.Columns.Add("CameraName");
            try
            {
                DirectX.Capture.Filters Dispositive = new DirectX.Capture.Filters();
                for (int i = 0; i < Dispositive.VideoInputDevices.Count;i++ )
                {
                    Filter f = Dispositive.VideoInputDevices[i];
                    DataRow dr = dt.NewRow();
                    dr["id"] = i;
                    dr["CameraName"] = f.Name;
                    dt.Rows.Add(dr);
                }


                //String strName = "".PadRight(100);
                //String strVer = "".PadRight(100);
                //bool bReturn = false;
                //short x = 0;
                ...
                //        DataRow dr = dt.NewRow();
                //        dr["id"] = x;
                //        dr["CamName"] = strName.Trim();
                //        dr["CamVer"] = strVer.Trim();
        ...
        public void Start()
        {
            try
            {
                ...
                //mCapHwnd = capCreateCaptureWindowA(CamIndex, 0, 0, 0, m_Width, m_Height, this.Handle.ToInt32(), 0);
