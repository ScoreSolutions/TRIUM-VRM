...
#End Region
	...
	Private Sub pictureBox_Paint(ByVal sender As Object, ByVal e As System.Windows.Forms.PaintEventArgs) Handles pictureBox.Paint
		Dim focusRegion As Nullable(Of RectangleF)
		SyncLock _statusLock
	...
	Private Sub pictureBox_MouseClick(ByVal sender As Object, ByVal e As MouseEventArgs) Handles pictureBox.MouseClick
		Dim area As Rectangle = GetPictureArea()
		Dim clickToFocus As Boolean = Me.ClickToFocus
		Dim method As OnPictureBoxClickedDelegate = AddressOf OnPictureBoxClicked
		Dim result As IAsyncResult = method.BeginInvoke(e, area, clickToFocus, Nothing, Nothing)
