...
Friend NotInheritable Class Program
	...
	<STAThread()> _
	Shared Sub Main()
		Dim components() As String = {"Biometrics.FingerDetection", "Devices.FingerScanners", "Devices.Cameras", "Biometrics.IrisDetection", "Devices.IrisScanners", "Devices.Microphones"}
		...
		Finally
			Utils.ReleaseLicenses(components)
		End Try
	End Sub
End Class
