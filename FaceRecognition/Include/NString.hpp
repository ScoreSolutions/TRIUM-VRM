...
public:
	static N_CLASS(NString) PromoteBuffer(NAChar * szValue, NInt length = -1, NMemoryType memoryType = nmmtDefault)
	{
		N_CLASS(NString) value;
		NCheck(NStringPromoteBufferA(szValue, length, memoryType, &value.handle));
		return value;
	}

#ifndef N_NO_UNICODE
	static N_CLASS(NString) PromoteBuffer(NWChar * szValue, NInt length = -1, NMemoryType memoryType = nmmtDefault)
	{
		N_CLASS(NString) value;
	...
	static NInt Compare(const N_CLASS(NString) & value, NInt index, const N_CLASS(NString) & otherValue, NInt otherIndex, NInt length, bool ignoreCase = false)
	{
		NInt result;
	...
	static NInt CompareA(const N_CLASS(NString) & value, NInt index, const N_CLASS(NString) & otherValue, NInt otherIndex, NInt length, bool ignoreCase = false)
	{
		NInt result;
...
#ifndef N_NO_UNICODE
	static NInt CompareW(const N_CLASS(NString) & value, NInt index, const N_CLASS(NString) & otherValue, NInt otherIndex, NInt length, bool ignoreCase = false)
	{
		NInt result;
	...
	static NInt Compare(const N_CLASS(NString) & value, const N_CLASS(NString) & otherValue, bool ignoreCase = false)
	{
		NInt result;
	...
	static NInt CompareA(const N_CLASS(NString) & value, const N_CLASS(NString) & otherValue, bool ignoreCase = false)
	{
		NInt result;
...
#ifndef N_NO_UNICODE
	static NInt CompareW(const N_CLASS(NString) & value, const N_CLASS(NString) & otherValue, bool ignoreCase = false)
	{
		NInt result;
	...
	static bool Equals(const N_CLASS(NString) & value, const N_CLASS(NString) & otherValue, bool ignoreCase = false)
	{
		NBool result;
	...
	static N_CLASS(NString) Concat(const N_CLASS(NString) & value1, const N_CLASS(NString) & value2)
	{
		HNString hResult;
		NCheck(NStringConcatN(value1.GetHandle(), value2.GetHandle(), &hResult));
		return N_CLASS(NString)(hResult, true);
	}

	static N_CLASS(NString) Concat(const NAChar * szValue1, const NAChar * szValue2)
	{
		HNString hResult;
...
#ifndef N_NO_UNICODE
	static N_CLASS(NString) Concat(const NWChar * szValue1, const NWChar * szValue2)
	{
		HNString hResult;
	...
	static N_CLASS(NString) Concat(const NAChar * arValue1, NInt value1Length, const NAChar * arValue2, NInt value2Length)
	{
		HNString hResult;
...
#ifndef N_NO_UNICODE
	static N_CLASS(NString) Concat(const NWChar * arValue1, NInt value1Length, const NWChar * arValue2, NInt value2Length)
	{
		HNString hResult;
	...
	static N_CLASS(NString) ConcatN(const N_CLASS(NString) * arValues, NInt count)
	{
		HNString hResult;
	...
	static N_CLASS(NString) Concat(const NAChar * const * arszValues, NInt count)
	{
		HNString hResult;
...
#ifndef N_NO_UNICODE
	static N_CLASS(NString) Concat(const NWChar * const * arszValues, NInt count)
	{
		HNString hResult;
	...
	static N_CLASS(NString) Concat(NInt count, va_list args)
	{
		HNString hResult;
	...
	static N_CLASS(NString) ConcatA(NInt count, va_list args)
	{
		HNString hResult;
...
#ifndef N_NO_UNICODE
	static N_CLASS(NString) ConcatW(NInt count, va_list args)
	{
		HNString hResult;
	...
	static N_CLASS(NString) Concat(NInt count, ...)
	{
		va_list args;
		va_start(args, count);
		try
		{
			N_CLASS(NString) v = Concat(count, args);
			va_end(args);
			return v;
		}
		catch (...)
	...
	static N_CLASS(NString) ConcatA(NInt count, ...)
	{
		va_list args;
		va_start(args, count);
		try
		{
			N_CLASS(NString) v = ConcatA(count, args);
			va_end(args);
			return v;
		}
		catch (...)
...
#ifndef N_NO_UNICODE
	static N_CLASS(NString) ConcatW(NInt count, ...)
	{
		va_list args;
		va_start(args, count);
		try
		{
			N_CLASS(NString) v = ConcatW(count, args);
			va_end(args);
			return v;
		}
		catch (...)
	...
	static N_CLASS(NString) Join(const N_CLASS(NString) & separator, const N_CLASS(NString) * arValues, NInt count)
	{
		HNString hResult;
	...
	static N_CLASS(NString) Join(const NAChar * szSeparator, const N_CLASS(NString) * arValues, NInt count)
	{
		HNString hResult;
...
#ifndef N_NO_UNICODE
	static N_CLASS(NString) Join(const NWChar * szSeparator, const N_CLASS(NString) * arValues, NInt count)
	{
		HNString hResult;
	...
	static N_CLASS(NString) Join(const NAChar * szSeparator, const NAChar * const * arszValues, NInt count)
	{
		HNString hResult;
...
#ifndef N_NO_UNICODE
	static N_CLASS(NString) Join(const NWChar * szSeparator, const NWChar * const * arszValues, NInt count)
	{
		HNString hResult;
	...
	static N_CLASS(NString) Join(const NAChar * szSeparator, NInt count, va_list args)
	{
		HNString hResult;
...
#ifndef N_NO_UNICODE
	static N_CLASS(NString) Join(const NWChar * szSeparator, NInt count, va_list args)
	{
		HNString hResult;
	...
	static N_CLASS(NString) Join(const NAChar * szSeparator, NInt count, ...)
	{
		va_list args;
		va_start(args, count);
		try
		{
			N_CLASS(NString) v = Join(szSeparator, count, args);
			va_end(args);
			return v;
		}
		catch (...)
...
#ifndef N_NO_UNICODE
	static N_CLASS(NString) Join(const NWChar * szSeparator, NInt count, ...)
	{
		va_list args;
		va_start(args, count);
		try
	...
	static N_CLASS(NString) Format(const N_CLASS(NString) & format, va_list args)
	{
		HNString hResult;
	...
	static N_CLASS(NString) Format(const NAChar * szFormat, va_list args)
	{
		HNString hResult;
...
#ifndef N_NO_UNICODE
	static N_CLASS(NString) Format(const NWChar * szFormat, va_list args)
	{
		HNString hResult;
	...
	static N_CLASS(NString) Format(const N_CLASS(NString) & format, ...)
	{
		va_list args;
		va_start(args, format);
		try
		{
			N_CLASS(NString) v = Format(format, args);
			va_end(args);
			return v;
		}
		catch (...)
	...
	static N_CLASS(NString) Format(const NAChar * szFormat, ...)
	{
		va_list args;
		va_start(args, szFormat);
		try
		{
			N_CLASS(NString) v = Format(szFormat, args);
			va_end(args);
			return v;
		}
		catch (...)
...
#ifndef N_NO_UNICODE
	static N_CLASS(NString) Format(const NWChar * szFormat, ...)
	{
		va_list args;
		va_start(args, szFormat);
		try
	...
	N_CLASS(NString)(const N_CLASS(NString) & other)
		: handle(NULL)
	{
		*this = other;
	}

	N_CLASS(NString)(HNString hValue, bool ownsHandle)
		: handle(ownsHandle ? hValue : NULL)
	{
		if (!ownsHandle) NCheck(NStringClone(hValue, &handle));
	}

	N_CLASS(NString)(NAChar value, NInt count)
		: handle(NULL)
	{
		NCheck(NStringCreateFromCharA(value, count, &handle));
	}

	N_CLASS(NString)(const NAChar * szValue)
		: handle(NULL)
	{
		*this = szValue;
	}
...
#ifndef N_NO_UNICODE
	N_CLASS(NString)(const NWChar * szValue)
		: handle(NULL)
	{
		*this = szValue;
	}
	...
	N_CLASS(NString)(const NAChar * arValue, NInt valueLength)
		: handle(NULL)
	{
...
#ifndef N_NO_UNICODE
	N_CLASS(NString)(const NWChar * arValue, NInt valueLength)
		: handle(NULL)
	{
	...
	NInt CompareTo(const N_CLASS(NString) & value, bool ignoreCase = false) const
	{
		NInt result;
	...
	NInt CompareToA(const N_CLASS(NString) & value, bool ignoreCase = false) const
	{
		NInt result;
...
#ifndef N_NO_UNICODE
	NInt CompareToW(const N_CLASS(NString) & value, bool ignoreCase = false) const
	{
		NInt result;
	...
	bool Equals(const N_CLASS(NString) & value, bool ignoreCase = false) const
	{
		NBool result;
	...
	bool StartsWith(const N_CLASS(NString) & value, bool ignoreCase = false) const
	{
		NBool result;
	...
	bool EndsWith(const N_CLASS(NString) & value, bool ignoreCase = false) const
	{
		NBool result;
	...
	NInt IndexOf(const N_CLASS(NString) & value, NInt startIndex, NInt count, bool ignoreCase = false) const
	{
		NInt index;
	...
	NInt IndexOfA(const N_CLASS(NString) & value, NInt startIndex, NInt count, bool ignoreCase = false) const
	{
		NInt index;
...
#ifndef N_NO_UNICODE
	NInt IndexOfW(const N_CLASS(NString) & value, NInt startIndex, NInt count, bool ignoreCase = false) const
	{
		NInt index;
	...
	NInt IndexOf(const N_CLASS(NString) & value, NInt startIndex, bool ignoreCase = false) const
	{
		NInt index;
	...
	NInt IndexOfA(const N_CLASS(NString) & value, NInt startIndex, bool ignoreCase = false) const
	{
		NInt index;
...
#ifndef N_NO_UNICODE
	NInt IndexOfW(const N_CLASS(NString) & value, NInt startIndex, bool ignoreCase = false) const
	{
		NInt index;
	...
	NInt IndexOf(const N_CLASS(NString) & value, bool ignoreCase = false) const
	{
		NInt index;
	...
	NInt IndexOfA(const N_CLASS(NString) & value, bool ignoreCase = false) const
	{
		NInt index;
...
#ifndef N_NO_UNICODE
	NInt IndexOfW(const N_CLASS(NString) & value, bool ignoreCase = false) const
	{
		NInt index;
	...
	NInt LastIndexOf(const N_CLASS(NString) & value, NInt startIndex, NInt count, bool ignoreCase = false) const
	{
		NInt index;
	...
	NInt LastIndexOfA(const N_CLASS(NString) & value, NInt startIndex, NInt count, bool ignoreCase = false) const
	{
		NInt index;
...
#ifndef N_NO_UNICODE
	NInt LastIndexOfW(const N_CLASS(NString) & value, NInt startIndex, NInt count, bool ignoreCase = false) const
	{
		NInt index;
	...
	NInt LastIndexOf(const N_CLASS(NString) & value, NInt startIndex, bool ignoreCase = false) const
	{
		NInt index;
	...
	NInt LastIndexOfA(const N_CLASS(NString) & value, NInt startIndex, bool ignoreCase = false) const
	{
		NInt index;
...
#ifndef N_NO_UNICODE
	NInt LastIndexOfW(const N_CLASS(NString) & value, NInt startIndex, bool ignoreCase = false) const
	{
		NInt index;
	...
	NInt LastIndexOf(const N_CLASS(NString) & value, bool ignoreCase = false) const
	{
		NInt index;
	...
	NInt LastIndexOfA(const N_CLASS(NString) & value, bool ignoreCase = false) const
	{
		NInt index;
...
#ifndef N_NO_UNICODE
	NInt LastIndexOfW(const N_CLASS(NString) & value, bool ignoreCase = false) const
	{
		NInt index;
	...
	bool Contains(const N_CLASS(NString) & value) const
	{
		NBool result;
	...
	N_CLASS(NString) * Split(const NAChar * arSeparators, NInt separatorCount, NInt * pValueCount, bool removeEmptyEntries = false, NInt count = N_INT_MAX) const
	{
		HNString * arhValues;
		NCheck(NStringSplitWithCountA(GetHandle(), arSeparators, separatorCount, count, removeEmptyEntries, &arhValues, pValueCount));
		return reinterpret_cast<N_CLASS(NString) *>(arhValues);
	}

#ifndef N_NO_UNICODE
	N_CLASS(NString) * Split(const NWChar * arSeparators, NInt separatorCount, NInt * pValueCount, bool removeEmptyEntries = false, NInt count = N_INT_MAX) const
	{
		HNString * arhValues;
	...
	N_CLASS(NString) * Split(const N_CLASS(NString) * arSeparators, NInt separatorCount, NInt * pValueCount, bool removeEmptyEntries = false, NInt count = N_INT_MAX) const
	{
		HNString * arhValues;
	...
	N_CLASS(NString) * Split(const NAChar * const * arszSeparators, NInt separatorCount, NInt * pValueCount, bool removeEmptyEntries = false, NInt count = N_INT_MAX) const
	{
		HNString * arhValues;
...
#ifndef N_NO_UNICODE
	N_CLASS(NString) * Split(const NWChar * const * arszSeparators, NInt separatorCount, NInt * pValueCount, bool removeEmptyEntries = false, NInt count = N_INT_MAX) const
	{
		HNString * arhValues;
	...
	N_CLASS(NString) ToString(const N_CLASS(NString) & format) const
	{
		HNString hValue;
	...
	N_CLASS(NString) ToString(const NAChar * szFormat) const
	{
		HNString hValue;
...
#ifndef N_NO_UNICODE
	N_CLASS(NString) ToString(const NWChar * szFormat) const
	{
		HNString hValue;
	...
	void ToStringOld(NAChar * szValue, NInt valueSize) const
	{
		NCheck(NStringToStringOldA(GetHandle(), szValue, valueSize));
	}

#ifndef N_NO_UNICODE
	void ToStringOld(NWChar * szValue, NInt valueSize) const
	{
		NCheck(NStringToStringOldW(GetHandle(), szValue, valueSize));
	}
#endif
	...
	N_CLASS(NString) Insert(NInt index, const N_CLASS(NString) & value) const
	{
		HNString hResult;
	...
	N_CLASS(NString) InsertA(NInt index, const N_CLASS(NString) & value) const
	{
		HNString hResult;
...
#ifndef N_NO_UNICODE
	N_CLASS(NString) InsertW(NInt index, const N_CLASS(NString) & value) const
	{
		HNString hResult;
	...
	N_CLASS(NString) Insert(NInt index, const NAChar * arValue, NInt valueLength = -1) const
	{
		HNString hResult;
...
#ifndef N_NO_UNICODE
	N_CLASS(NString) Insert(NInt index, const NWChar * arValue, NInt valueLength = -1) const
	{
		HNString hResult;
	...
	N_CLASS(NString) Remove(NInt startIndex, NInt count) const
	{
		HNString hResult;
	...
	N_CLASS(NString) RemoveA(NInt startIndex, NInt count) const
	{
		HNString hResult;
...
#ifndef N_NO_UNICODE
	N_CLASS(NString) RemoveW(NInt startIndex, NInt count) const
	{
		HNString hResult;
	...
	N_CLASS(NString) Remove(NInt startIndex) const
	{
		HNString hResult;
	...
	N_CLASS(NString) RemoveA(NInt startIndex) const
	{
		HNString hResult;
...
#ifndef N_NO_UNICODE
	N_CLASS(NString) RemoveW(NInt startIndex) const
	{
		HNString hResult;
	...
	N_CLASS(NString) Substring(NInt startIndex, NInt count) const
	{
		HNString hResult;
	...
	N_CLASS(NString) SubstringA(NInt startIndex, NInt count) const
	{
		HNString hResult;
...
#ifndef N_NO_UNICODE
	N_CLASS(NString) SubstringW(NInt startIndex, NInt count) const
	{
		HNString hResult;
	...
	N_CLASS(NString) Substring(NInt startIndex) const
	{
		HNString hResult;
	...
	N_CLASS(NString) SubstringA(NInt startIndex) const
	{
		HNString hResult;
...
#ifndef N_NO_UNICODE
	N_CLASS(NString) SubstringW(NInt startIndex) const
	{
		HNString hResult;
	...
	N_CLASS(NString) TrimStart() const
	{
		HNString hResult;
	...
	N_CLASS(NString) Trim(const NAChar * arChars, NInt charCount) const
	{
		HNString hResult;
...
#ifndef N_NO_UNICODE
	N_CLASS(NString) Trim(const NWChar * arChars, NInt charCount) const
	{
		HNString hResult;
	...
	N_CLASS(NString) TrimStart(const NAChar * arChars, NInt charCount) const
	{
		HNString hResult;
...
#ifndef N_NO_UNICODE
	N_CLASS(NString) TrimStart(const NWChar * arChars, NInt charCount) const
	{
		HNString hResult;
	...
	N_CLASS(NString) TrimEnd(const NAChar * arChars, NInt charCount) const
	{
		HNString hResult;
...
#ifndef N_NO_UNICODE
	N_CLASS(NString) TrimEnd(const NWChar * arChars, NInt charCount) const
	{
		HNString hResult;
	...
	N_CLASS(NString) PadLeft(NInt totalWidth) const
	{
		HNString hResult;
	...
	N_CLASS(NString) PadLeftA(NInt totalWidth) const
	{
		HNString hResult;
...
#ifndef N_NO_UNICODE
	N_CLASS(NString) PadLeftW(NInt totalWidth) const
	{
		HNString hResult;
	...
	N_CLASS(NString) PadRight(NInt totalWidth) const
	{
		HNString hResult;
	...
	N_CLASS(NString) PadRightA(NInt totalWidth) const
	{
		HNString hResult;
		NCheck(NStringPadRightA(GetHandle(), totalWidth, &hResult));
		return N_CLASS(NString)(hResult, true);
...
#ifndef N_NO_UNICODE
	N_CLASS(NString) PadRightW(NInt totalWidth) const
	{
		HNString hResult;
	...
	N_CLASS(NString) PadLeft(NInt totalWidth, NAChar paddingChar) const
	{
		HNString hResult;
...
#ifndef N_NO_UNICODE
	N_CLASS(NString) PadLeft(NInt totalWidth, NWChar paddingChar) const
	{
		HNString hResult;
	...
	N_CLASS(NString) PadRight(NInt totalWidth, NAChar paddingChar) const
	{
		HNString hResult;
...
#ifndef N_NO_UNICODE
	N_CLASS(NString) PadRight(NInt totalWidth, NWChar paddingChar) const
	{
		HNString hResult;
	...
	N_CLASS(NString) Replace(NAChar oldChar, NAChar newChar) const
	{
		HNString hResult;
...
#ifndef N_NO_UNICODE
	N_CLASS(NString) Replace(NWChar oldChar, NWChar newChar) const
	{
		HNString hResult;
	...
	N_CLASS(NString) Replace(const N_CLASS(NString) & oldValue, const N_CLASS(NString) & newValue) const
	{
		HNString hResult;
	...
	N_CLASS(NString) Replace(const NAChar * szOldValue, const NAChar * szNewValue) const
	{
		HNString hResult;
...
#ifndef N_NO_UNICODE
	N_CLASS(NString) Replace(const NWChar * szOldValue, const NWChar * szNewValue) const
	{
		HNString hResult;
	...
	N_CLASS(NString) Replace(const NAChar * arOldValue, NInt oldValueLength, const NAChar * arNewValue, NInt newValueLength) const
	{
		HNString hResult;
...
#ifndef N_NO_UNICODE
	N_CLASS(NString) Replace(const NWChar * arOldValue, NInt oldValueLength, const NWChar * arNewValue, NInt newValueLength) const
	{
		HNString hResult;
	...
	N_CLASS(NString) Prepend(const NAChar * arValue, NInt valueLength = -1) const
	{
		HNString hResult;
...
#ifndef N_NO_UNICODE
	N_CLASS(NString) Prepend(const NWChar * arValue, NInt valueLength = -1) const
	{
		HNString hResult;
	...
	N_CLASS(NString) Append(const NAChar * arValue, NInt valueLength = -1) const
	{
		HNString hResult;
...
#ifndef N_NO_UNICODE
	N_CLASS(NString) Append(const NWChar * arValue, NInt valueLength = -1) const
	{
		HNString hResult;
	...
	N_CLASS(NString) & operator=(const N_CLASS(NString) & other)
	{
		return *this = other.handle;
	}

	N_CLASS(NString) & operator=(HNString hOtherValue)
	{
	...
	N_CLASS(NString) & operator=(const NAChar * szValue)
	{
		HNString hValue;
...
#ifndef N_NO_UNICODE
	N_CLASS(NString) & operator=(const NWChar * szValue)
	{
		HNString hValue;
...
inline bool operator==(const N_CLASS(NString) & value1, const N_CLASS(NString) & value2)
{
	return N_CLASS(NString)::Equals(value1, value2);
}
...
inline bool operator==(const N_CLASS(NString) & value1, const NAChar * szValue2)
{
...
#ifndef N_NO_UNICODE
inline bool operator==(const N_CLASS(NString) & value1, const NWChar * szValue2)
{
	return value1.Equals(szValue2);
}
...
inline bool operator==(const NAChar * szValue1, const N_CLASS(NString) & value2)
{
...
#ifndef N_NO_UNICODE
inline bool operator==(const NWChar * szValue1, const N_CLASS(NString) & value2)
{
	return value2.Equals(szValue1);
}
...
inline N_CLASS(NString) operator +(const N_CLASS(NString) & value1, const N_CLASS(NString) & value2)
{
	return N_CLASS(NString)::Concat(value1, value2);
}

inline N_CLASS(NString) operator +(const N_CLASS(NString) & value1, const NAChar * szValue2)
{
	return value1.Append(szValue2);
}

#ifndef N_NO_UNICODE
inline N_CLASS(NString) operator +(const N_CLASS(NString) & value1, const NWChar * szValue2)
{
	return value1.Append(szValue2);
}
#endif

inline N_CLASS(NString) operator +(const NAChar * szValue1, const N_CLASS(NString) & value2)
{
	return value2.Prepend(szValue1);
}

#ifndef N_NO_UNICODE
inline N_CLASS(NString) operator +(const NWChar * szValue1, const N_CLASS(NString) & value2)
{
	return value2.Prepend(szValue1);
}
#endif
...
private:
	...
	N_CLASS(NStringWrapper)(const N_CLASS(NStringWrapper) &);
	N_CLASS(NStringWrapper) & operator=(const N_CLASS(NStringWrapper) &);

public:
	N_CLASS(NStringWrapper)(const NAChar * szValue, NInt length = -1)
...
#ifndef N_NO_UNICODE
	N_CLASS(NStringWrapper)(const NWChar * szValue, NInt length = -1)
		: header(), handle(NULL), ownsHandle(true)
	{
	...
	N_CLASS(NStringWrapper)(HNString hValue)
		: header(), handle(hValue), ownsHandle(false)
	{
	}

	N_CLASS(NStringWrapper)(const N_CLASS(NString) & value)
		: header(), handle(value.GetHandle()), ownsHandle(false)
	{
	}

	N_CLASS(NStringWrapper)(::Neurotec::Text::N_CLASS(NStringBuilder) & value);

#ifdef N_FRAMEWORK_NATIVE
	N_CLASS(NStringWrapper)(const std::string & value)
		: header(), handle(NULL), ownsHandle(true)
	{
...
#ifndef N_NO_UNICODE
	N_CLASS(NStringWrapper)(const std::wstring & value)
		: header(), handle(NULL), ownsHandle(true)
	{
...
#ifdef N_FRAMEWORK_MFC
	N_CLASS(NStringWrapper)(const CStringA & value)
		: header(), handle(NULL), ownsHandle(true)
	{
		NCheck(NStringCreateWrapperA(value.GetString(), value.GetLength(), &header, &handle));
	}

	N_CLASS(NStringWrapper)(const CStringW & value)
		: header(), handle(NULL), ownsHandle(true)
	{
...
#ifdef N_FRAMEWORK_WX
	#if wxUSE_UNICODE == 1 && defined(N_NO_UNICODE)
		N_CLASS(NStringWrapper)(const wxChar * szValue, NInt length = -1)
			: header(), handle(NULL), ownsHandle(true)
		{
	...
	N_CLASS(NStringWrapper)(const wxString & value)
		: header(), handle(NULL), ownsHandle(true)
	{
	#if wxUSE_UNICODE == 1 && defined(N_NO_UNICODE)
...
#ifdef N_FRAMEWORK_QT
	N_CLASS(NStringWrapper)(const QString & value)
		: header(), handle(NULL), ownsHandle(true)
	{
	...
	N_CLASS(NString) GetString() const
	{
		return N_CLASS(NString)(handle, false);
	}

	operator N_CLASS(NString)() const
	{
		return GetString();
	}
};
