...
class N_CLASS(NVideoFormat) : public N_CLASS(NMediaFormat)
{
...
private:
	...
	N_CLASS(NVideoFormat)(HNObject handle, bool claimHandle)
...
public:
	...
	N_CLASS(NVideoFormat)()
		: N_CLASS(NMediaFormat)(Create(), true)
	{
		N_OBJECT_CLASS_REGISTER_TYPE(NVideoFormat);
	}
	...
	N_CLASS(NURational) GetFrameRate() const
	{
		N_CLASS(NURational) value;
		NCheck(NVideoFormatGetFrameRate(GetHandle(), &value));
		return value;
	}

	void SetFrameRate(const N_CLASS(NURational) & value)
	{
	...
	N_CLASS(NURational) GetPixelAspectRatio() const
	{
		N_CLASS(NURational) value;
	...
	void SetPixelAspectRatio(const N_CLASS(NURational) & value)
	{
