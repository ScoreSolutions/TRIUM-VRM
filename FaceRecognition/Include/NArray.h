...
NResult N_API NArrayCreate(HNType hType, const void * arValues, NSizeType valuesSize, NInt valuesLength, NAttributes attributes, HNArray * phValue);
NResult N_API NArrayCreateP(NTypeOfProc pTypeOf, const void * arValues, NSizeType valuesSize, NInt valuesLength, NAttributes attributes, HNArray * phValue);
NResult N_API NArrayCreateCustomN(const void * const * arValues, NInt valuesLength, HNCallback hFree, HNCallback hGetHashCode, HNCallback hEquals, NAttributes attributes, HNArray * phValue);
NResult N_API NArrayCreateCustom(const void * const * arValues, NInt valuesLength, NPointerFreeProc pFree, void * pFreeParam,
	NPointerGetHashCodeProc pGetHashCode, void * pGetHashCodeParam, NPointerEqualsProc pEquals, void * pEqualsParam, NAttributes attributes, HNArray * phValue);
NResult N_API NArrayCreateFromByteArray(const NByte * arValues, NInt valuesLength, NAttributes attributes, HNArray * phValue);
NResult N_API NArrayCreateFromSByteArray(const NSByte * arValues, NInt valuesLength, NAttributes attributes, HNArray * phValue);
NResult N_API NArrayCreateFromUInt16Array(const NUShort * arValues, NInt valuesLength, NAttributes attributes, HNArray * phValue);
NResult N_API NArrayCreateFromInt16Array(const NShort * arValues, NInt valuesLength, NAttributes attributes, HNArray * phValue);
NResult N_API NArrayCreateFromUInt32Array(const NUInt * arValues, NInt valuesLength, NAttributes attributes, HNArray * phValue);
NResult N_API NArrayCreateFromInt32Array(const NInt * arValues, NInt valuesLength, NAttributes attributes, HNArray * phValue);
NResult N_API NArrayCreateFromUInt64Array(const NULong * arValues, NInt valuesLength, NAttributes attributes, HNArray * phValue);
NResult N_API NArrayCreateFromInt64Array(const NLong * arValues, NInt valuesLength, NAttributes attributes, HNArray * phValue);
NResult N_API NArrayCreateFromSingleArray(const NFloat * arValues, NInt valuesLength, NAttributes attributes, HNArray * phValue);
NResult N_API NArrayCreateFromDoubleArray(const NDouble * arValues, NInt valuesLength, NAttributes attributes, HNArray * phValue);
NResult N_API NArrayCreateFromBooleanArray(const NBool * arValues, NInt valuesLength, NAttributes attributes, HNArray * phValue);
NResult N_API NArrayCreateFromSizeTypeArray(const NSizeType * arValues, NInt valuesLength, NAttributes attributes, HNArray * phValue);
NResult N_API NArrayCreateFromSSizeTypeArray(const NSSizeType * arValues, NInt valuesLength, NAttributes attributes, HNArray * phValue);
NResult N_API NArrayCreateFromPointerArray(const void * const * arValues, NInt valuesLength, NAttributes attributes, HNArray * phValue);
NResult N_API NArrayCreateFromResultArray(const NResult * arValues, NInt valuesLength, NAttributes attributes, HNArray * phValue);

NResult N_API NArrayCreateFromCharArrayA(const NAChar * arValues, NInt valuesLength, NAttributes attributes, HNArray * phValue);
#ifndef N_NO_UNICODE
NResult N_API NArrayCreateFromCharArrayW(const NWChar * arValues, NInt valuesLength, NAttributes attributes, HNArray * phValue);
#endif
#ifdef N_DOCUMENTATION
NResult N_API NArrayCreateFromCharArray(const NChar * arValues, NInt valuesLength, NAttributes attributes, HNArray * phValue);
#endif
#define NArrayCreateFromCharArray N_FUNC_AW(NArrayCreateFromCharArray)

NResult N_API NArrayCreateFromStringArrayN(const HNString * arhValues, NInt valuesLength, NAttributes attributes, HNArray * phValue);
NResult N_API NArrayCreateFromStringArrayA(const NAChar * const * arszValues, NInt valuesLength, NAttributes attributes, HNArray * phValue);
#ifndef N_NO_UNICODE
NResult N_API NArrayCreateFromStringArrayW(const NWChar * const * arszValues, NInt valuesLength, NAttributes attributes, HNArray * phValue);
#endif
#ifdef N_DOCUMENTATION
NResult N_API NArrayCreateFromStringArray(const NChar * const * arszValues, NInt valuesLength, NAttributes attributes, HNArray * phValue);
#endif
#define NArrayCreateFromStringArray N_FUNC_AW(NArrayCreateFromStringArray)

NResult N_API NArrayCreateFromObjectArray(HNType hType, const HNObject * arhValues, NInt valuesLength, NAttributes attributes, HNArray * phValue);
NResult N_API NArrayCreateFromObjectArrayP(NTypeOfProc pTypeOf, const HNObject * arhValues, NInt valuesLength, NAttributes attributes, HNArray * phValue);
