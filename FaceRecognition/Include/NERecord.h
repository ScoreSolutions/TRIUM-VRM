...
#define NERecordGetSize(hRecord, flags, pValue) NObjectGetSize(hRecord, flags, pValue)
#define NERecordSaveToMemory(hRecord, pBuffer, bufferSize, flags, pSize) NObjectSaveToMemoryDst(hRecord, pBuffer, bufferSize, flags, pSize)
...
#define NERecordClone(hRecord, phClonedRecord) NObjectClone(hRecord, (HNObject *)phClonedRecord)

#ifdef N_MSVC
	#pragma deprecated("NERecordGetSize", "NERecordSaveToMemory")
	#pragma deprecated("NERecordClone")
#endif
