...
N_DEPRECATED("function is deprecated, use NMemoryStreamGetBuffer instead")
NResult N_API NMemoryStreamDetachBuffer(HNMemoryStream hStream, void * * ppBuffer, NSizeType * pBufferSize);
