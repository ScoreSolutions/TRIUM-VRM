...
#define N_EVENT_IMPL(argCount, argsDef, callbackArgTypes, callbackArgs) \
	...
	public:\
		...
		void Add(const N_CLASS(NCallback) & callback)\
		{\
		...
		void Remove(const N_CLASS(NCallback) & callback)\
		{\
...
template<typename T1> class N_CLASS(NEvent1) : private Internal::NEvent
{
	N_EVENT_IMPL(1, (T1 p1), (T1, void *), (p1, NCallbackGetParam(*phCallback)))
};

template<typename T1, typename T2> class N_CLASS(NEvent2) : private Internal::NEvent
{
	N_EVENT_IMPL(2, (T1 p1, T2 p2), (T1, T2, void *), (p1, p2, NCallbackGetParam(*phCallback)))
};

template<typename T1, typename T2, typename T3> class N_CLASS(NEvent3) : private Internal::NEvent
{
	N_EVENT_IMPL(3, (T1 p1, T2 p2, T3 p3), (T1, T2, T3, void *), (p1, p2, p3, NCallbackGetParam(*phCallback)))
};

template<typename T1, typename T2, typename T3, typename T4> class N_CLASS(NEvent4) : private Internal::NEvent
{
	N_EVENT_IMPL(4, (T1 p1, T2 p2, T3 p3, T4 p4), (T1, T2, T3, T4, void *), (p1, p2, p3, p4, NCallbackGetParam(*phCallback)))
};

template<typename T1, typename T2, typename T3, typename T4, typename T5> class N_CLASS(NEvent5) : private Internal::NEvent
{
	N_EVENT_IMPL(5, (T1 p1, T2 p2, T3 p3, T4 p4, T5 p5), (T1, T2, T3, T4, T5, void *), (p1, p2, p3, p4, p5, NCallbackGetParam(*phCallback)))
};

template<typename T1, typename T2, typename T3, typename T4, typename T5, typename T6> class N_CLASS(NEvent6) : private Internal::NEvent
{
