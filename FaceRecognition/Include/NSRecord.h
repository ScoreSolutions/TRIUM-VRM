...
#define NSRecordGetSize(hRecord, flags, pValue) NObjectGetSize(hRecord, flags, pValue)
#define NSRecordSaveToMemory(hRecord, pBuffer, bufferSize, flags, pSize) NObjectSaveToMemoryDst(hRecord, pBuffer, bufferSize, flags, pSize)
...
#ifdef N_MSVC
	#pragma deprecated("NSRecordGetSize", "NSRecordSaveToMemory")
#endif
