...
typedef struct NdmInterfaceV1_
{
	...
	// Recommended for ndtBiometricDevice. The default value will be infered from GetDeviceType if the function is missing.
	...
	// V1.1
	//--------
	// Optional for ndtCaptureDevice. The default value will be infered from GetDeviceType if the function is missing.
