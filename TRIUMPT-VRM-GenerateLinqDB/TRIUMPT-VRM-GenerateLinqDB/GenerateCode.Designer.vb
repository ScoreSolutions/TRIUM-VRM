...
Partial Class GenerateCode
    ...
    Private Sub InitializeComponent()
        ...
        Me.txtDatabaseName.Text = "TRIUMPT-VRM"
        '
        'txtUserID
        '
        ...
        Me.txtDataSource.Text = "192.168.1.104"
        '
        'txtProjectCode
        '
        ...
        Me.txtProjectCode.Text = "TRIUMPT-VRM"
        '
        'Label7
        '
        ...
        Me.txtOutputPath.Text = "D:\MyProject\TRIUM-VRM\ShareObject\"
        '
        'btnGenAll
        '
